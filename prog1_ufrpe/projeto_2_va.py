...
def cadastro_disciplina():
    ...
    return projeto.Window('Tela de Cadastro de Disciplina', layout=layout, finalize=True)
...
while True:
    ...
    if janela == janela1 and evento == 'Prosseguir Cadastro' and valores['cadDiscp']:
        ...
        buttons, vallues = janela2.read()
        # Criação de Arquivo
        file = open(f"Disciplina - {vallues['disciplina']}.txt", 'w+', encoding="utf8")
